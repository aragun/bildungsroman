...
//QNetworkAccessManager *Dialog::s_networkAccessManager = 0;
...

{
    ...
    auto authManager = this->networkAccessManager();
    if(useCookie_)
    {
...
QNetworkAccessManager *Dialog::networkAccessManager()
{
    //if (!s_networkAccessManager) {
        s_networkAccessManager = new QNetworkAccessManager(this);
    //}
